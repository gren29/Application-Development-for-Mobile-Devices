...
public class Figura extends View {
    ...
    public Figura(Context c, String fig, int n_lad) {
        ...
        this.figura = fig;
        this.n_lados = n_lad;
        this.obj = new Obj(this.figura, this.n_lados);
        Paint paint = new Paint();
        this.paint = paint;
    ...
    protected void onDraw(Canvas paramCanvas) {
        ...
        p.setTextSize(50);
        paramCanvas.drawText("Volumen : ",posX/3,(posY/3)*2,p);
        paramCanvas.drawText("Coordenasa : ",(posX/3),(posY/3)*2+100,p);
        paramCanvas.drawText("A = (0 , 0 , 0 ) ",(posX/3),(posY/3)*2+180,p);
        paramCanvas.drawText("B = ( , , ) ",(posX/3),(posY/3)*2+260,p);
        paramCanvas.drawText("C = ( , , ) ",(posX/3),(posY/3)*2+340,p);
        paramCanvas.drawText("D = ( , , ) ",(posX/3),(posY/3)*2+420,p);
